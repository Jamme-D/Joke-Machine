...
// VoiceRSS Javascript SDK from min.js file
...
function tellMe(joke) {
    VoiceRSS.speech({
        key: 'ba4be151e0c7434e9becf6388048ec07',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    ...
    try {
        ...
        // Separates one-liners from two-part jokes
        if (data.setup) {
            // Use template string to easily parse variables and strings
...
// Add event listeners to combine play function w/ button
